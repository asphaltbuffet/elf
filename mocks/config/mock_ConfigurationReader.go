...
// GetConfigFileUsed provides a mock function for the type MockConfigurationReader
func (_mock *MockConfigurationReader) GetConfigFileUsed() string {
	ret := _mock.Called()
...
func (_c *MockConfigurationReader_GetConfigFileUsed_Call) Return(s string) *MockConfigurationReader_GetConfigFileUsed_Call {
	_c.Call.Return(s)
	return _c
}

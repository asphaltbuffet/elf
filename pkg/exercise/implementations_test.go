...
func setupTestCase(t *testing.T) func(t *testing.T) {
	...
	require.NoError(t, testFs.MkdirAll(
		filepath.Join("testdata", "2015", "01-testDayOne", "go"),
		0o750))
	require.NoError(t, testFs.MkdirAll(
		filepath.Join("testdata", "2015", "01-testDayOne", "py"),
		0o750))
	require.NoError(t, testFs.MkdirAll(
		filepath.Join("testdata", "2016", "01-testDayOne", "go"),
		0o750))
	require.NoError(t, testFs.MkdirAll(
		filepath.Join("testdata", "2017", "01-testDayOne"),
		0o750))
	require.NoError(t, testFs.MkdirAll(
		filepath.Join("testdata", "2018"),
		0o750))
	require.NoError(t, testFs.MkdirAll(
		filepath.Join("testdata", "2020", "01-testDayOne", "fake"),
		0o750))
	require.NoError(t, testFs.MkdirAll(
		filepath.Join("testdata", "2021", "01-testDayOne", "py"),
		0o750))
	require.NoError(t, testFs.MkdirAll(
		filepath.Join("testdata", "2021", "01-testDayOne", "fake"),
		0o750))
